                        ...
                        <div class="col-12 col-sm-12 col-md-9 col-lg-9">
                            ...
                            <div class="row pb-4">
                                <div class="col">
                                    ...
                                    <input readonly type="text" name="name" class="form-control" id="nome" aria-describedby="dicaNome" value="{{ $usuario->name }}"/>
...
<x-modal.confirmar-exclusao o="self" :n="$usuario->name" :id="$usuario->id" :modalId="confirmarExclusao" />
