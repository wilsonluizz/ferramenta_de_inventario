                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @can('admin')
                                        ...
                                        <a class="btn btn-secondary" href="{{ route('usuarios.edit', $u->id) }}" data-toggle="tooltip" title="Editar {{ $u->name }}">
                                            <i class="bi bi-pencil-fill"></i>
                                        </a>

                                        {{-- DELETE --}}
                                        {{-- <a class="btn btn-danger" href="{{ route('usuarios.show', $u->id) }}" data-toggle="tooltip" title="Ver detalhes de {{ $u->name }}">
                                            <i class="bi bi-trash-fill"></i>
                                        </a> --}}

                                    @else

                                        <a class="btn btn-primary" href="{{ route('usuarios.show', $u->id) }}" data-toggle="tooltip" title="Ver detalhes de {{ $u->name }}">
