                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @can('admin')
                                        ...
                                        <a class="btn btn-secondary" href="{{ route('permissoes.edit', $p->id) }}" data-toggle="tooltip" title="Editar {{ $p->name }}">
                                            <i class="bi bi-pencil-fill"></i>
                                        </a>

                                        {{-- DELETE --}}
                                        {{-- <button class="btn btn-danger" data-toggle="tooltip" title="Excluir permissão {{ $p->name }}" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="bi bi-trash-fill"></i>
                                        </button> --}}
                                    
                                    @else
                                    
                                        <a class="btn btn-primary" href="{{ route('permissoes.show', $p->id) }}" data-toggle="tooltip" title="Detalhes de {{ $p->name }}">
